...
#define LOADER_NS_MSP_STACK_SIZE 0x0010000 // 64K
#define LOADER_NS_HEAP_SIZE      0x0010000 // 64K
#define LOADER_NS_PSP_STACK_SIZE 0x0004000 // 16K
...
#define NS_HEAP_SIZE            0x0010000 // 64K
#define NS_MSP_STACK_SIZE       0x0010000 // 64K
#define NS_PSP_STACK_SIZE       0x0004000 // 16K
...
#define LOADER_NS_CODE_SIZE                 (0xA000) /* 40 Kbytes  */
