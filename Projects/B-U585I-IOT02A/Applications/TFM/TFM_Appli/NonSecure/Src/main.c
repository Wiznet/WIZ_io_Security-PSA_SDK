...
/*int main(void) */
{
  ...
  */
  ...
  printf("WIZCHIP = %d\r\n", _WIZCHIP_);
  printf(" Version of the PSA Framework API : 0x%x\r\n", psa_framework_version());
  wizchip_timer_init();
  wizchip_net_init();
...
void FW_APP_PrintMainMenu(void)
{
  ...
  printf("  Test WIZCHIP Loopback --------------------------------- 5\r\n\n");
#endif
#if WIZCHIP_TEST_KEY_PROVISIONING
  printf("  Test WIZCHIP AWS Key provisioning --------------------- 6\r\n\n");
#endif
#if WIZCHIP_TEST_AWS_IOT
  printf("  Test WIZCHIP AWS IoT ---------------------------------- 7\r\n\n");
#endif
...
#if WIZCHIP_TEST_LOOPBACK
        case '5' :
          printf("Start WIZCHIP Loopback Test !\r\n");
          printf("If you want to end the test, reset your device...\r\n\r\n");
          wizchip_test_loopback();
          break;
#endif /* WIZCHIP_TEST_LOOPBACK */
#if WIZCHIP_TEST_KEY_PROVISIONING
        case '6' :
          printf("Start WIZCHIP key provisioning Test !\r\n");
          printf("If you want to end the test, reset your device...\r\n\r\n");
          wizchip_test_key_provisioning();
          break;          
#endif /* WIZCHIP_TEST_KEY_PROVISIONING */
#if WIZCHIP_TEST_AWS_IOT
        case '7' :
          printf("Start WIZCHIP AWS IoT Test !\r\n");
          printf("If you want to end the test, reset your device...\r\n\r\n");
          wizchip_test_aws_iot();
          break;
#endif /* WIZCHIP_TEST_AWS_IOT */
